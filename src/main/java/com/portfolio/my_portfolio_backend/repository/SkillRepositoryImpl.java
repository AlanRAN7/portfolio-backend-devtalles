...
public class SkillRepositoryImpl implements ISkillRepository {
    ...
    private final RowMapper<Skill> skillRowMapper = (result, numRow) -> {
        Skill skill = new Skill();
        skill.setId(result.getLong("id"));
        skill.setName(result.getString("name"));
        skill.setIconClass(result.getString("icon_class"));
        skill.setLevelPercentage(result.getInt("level_percentage"));
        skill.setPersonalInfoId(result.getLong("personal_info_id"));
        return skill;
    };
